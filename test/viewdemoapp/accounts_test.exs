defmodule Viewdemoapp.AccountsTest do
  use Viewdemoapp.DataCase

  alias Viewdemoapp.Accounts

  describe "users" do
    alias Viewdemoapp.Accounts.User

    import Viewdemoapp.AccountsFixtures
