defmodule UserCrudAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(UserCrudAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(UserCrudAppWeb.Gettext, "errors", msg, opts)
    end
  end
