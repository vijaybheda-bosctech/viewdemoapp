defmodule ViewdemoappWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ViewdemoappWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ViewdemoappWeb.Gettext, "errors", msg, opts)
    end
  end
